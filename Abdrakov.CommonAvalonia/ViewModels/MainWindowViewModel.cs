...
namespace Abdrakov.CommonAvalonia.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        private Avalonia.Media.Imaging.Bitmap logoImage;
        ...
        public override void OnViewAttached()
        {
            ...
            if (Container.IsRegistered<BaseWindowSettings>())
            {
                ...
                {
                    LogoImage = new Avalonia.Media.Imaging.Bitmap(AssetLoader.Open(new Uri(_windowSettings.LogoImage)));
                }
