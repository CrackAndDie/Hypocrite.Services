...
namespace Abdrakov.CommonAvalonia.Views.Other
{
    public partial class WindowHeaderView : UserControl
    {
        public Avalonia.Media.Imaging.Bitmap LogoImage
        {
            get { return (Avalonia.Media.Imaging.Bitmap)GetValue(LogoImageProperty); }
            set { SetValue(LogoImageProperty, value); }
        }

        public static readonly StyledProperty<Avalonia.Media.Imaging.Bitmap> LogoImageProperty =
            AvaloniaProperty.Register<WindowHeaderView, Avalonia.Media.Imaging.Bitmap>("LogoImage");
